...
public class DataInitializer implements CommandLineRunner {
        ...
        private void seedArticle1(Issue issue) {
                ...
                addSections(article, List.of(
                                ...
                                new String[] { "Key Points",
                                                "Patients valued proximity and known providers, but referral complexity "
                                                                +
                                ...
                                new String[] { "Conclusion",
                                                "University-based health systems can become trusted local bridges when "
                                                                +
        ...
        private void seedArticle2(Issue issue) {
                ...
                addSections(article, List.of(
                                new String[] { "Abstract",
                                                "Teaching pharmacies can support antimicrobial stewardship by combining "
                                                                +
                                ...
                                new String[] { "Conclusion",
                                                "Stewardship should be treated as an applied professional habit, " +
        ...
        private void seedArticle3(Issue issue) {
                ...
                addSections(article, List.of(
                                ...
                                new String[] { "Conclusion",
                                                "Climate resilience depends on both agronomic technique and the social "
                                                                +
        ...
        private void seedArticle4(Issue issue) {
                ...
                addSections(article, List.of(
                                ...
                                new String[] { "Conclusion",
                                                "A university clinic can become a trusted access point when education, "
                                                                +
        ...
        private void seedArticle5(Issue issue) {
                ...
                addSections(article, List.of(
                                new String[] { "Abstract",
                                                "Students reported high experimentation with AI tools but uneven confidence "
                                                                +
                                ...
                                new String[] { "Conclusion",
                                                "Academic integrity policy should be course-visible, example-driven, " +
        ...
        private void seedSubmissions() {
                ...
                submissionRepository.save(Submission.builder()
                                ...
                                .assignedEditor(editor)
                                .editorDecisionNote(
                                                "Interesting topic — please expand the methodology section and clarify sampling.")
                                .copyrightAgreed(true)
